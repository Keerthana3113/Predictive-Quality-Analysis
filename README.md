...
### 1️ Clone Repository
```bash
git clone https://github.com/your-username/3d-defect-predictor.git
cd 3d-defect-predictor
````
...
##  Dashboard Preview
<img width="519" height="665" alt="Screenshot 2026-03-02 130313" src="https://github.com/user-attachments/assets/0284dd36-1943-4e9e-a5ea-bd0485154d8c" />
...
* Random Forest / Deep Learning models
* Cloud deployment
* Real-time IoT printer integration
